...
function Info () {
    ...
    const [key, setKey] = useState('voff');
    ...
    return (
        <div className="Info">
            ...
            <Tab eventKey="mjau" title="Fleksibilitet">
                <p>Mjau</p>
            </Tab>
            <Tab eventKey="voff2" title="Kategori">
                <p>Voff</p>
            </Tab>
            <Tab eventKey="voff3" title="Kategori">
                <p>Voff</p>
            </Tab>
            <Tab eventKey="voff4" title="Kategori">
                <p>Voff</p>
            </Tab>
            <Tab eventKey="voff5" title="Kategori">
                <p>Voff</p>
            </Tab>
            <Tab eventKey="voff6" title="Kategori">
                <p>Voff</p>
            </Tab>
            <Tab eventKey="voff7" title="Kategori">
                <p>Voff</p>
            </Tab>
            </Tabs></Container>
        </div>
